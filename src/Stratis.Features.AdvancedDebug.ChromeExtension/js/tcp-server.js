...
(function (exports) {
    ...
    *
    * @param {String} addr The remote address to connect to
    ...
    * preferred network as the addr parameter on TcpServer constructor.
    */
   ...
   TcpServer.prototype._onListenComplete = function (resultCode) {
      if (resultCode !== 0) {
         error('Unable to listen to socket. Result code = ' + resultCode);
      }
   };
    ...
    * @param {Object} socketInfo Socket Info.
    */
